...
import 'package:quiz/models/shop_item_model.dart';
import 'package:quiz/models/user_model.dart';
import 'package:quiz/services/shop_services.dart';
import 'package:quiz/services/user_services.dart';
import 'package:quiz/views/shop/coin/coin_item_view.dart';
import 'package:quiz/views/shop/gem/gem_item_view.dart';
...
class ShopVIewModel extends ChangeNotifier {
  ...
  List<CoinItemView> generateCoinItem() {
    return List.generate(
        coinItems.length,
        (index) => CoinItemView(
            quantity: coinItems[index].quantity,
            price: coinItems[index].price));
  }
  ...
  List<GemItemView> generateGemItem() {
    return List.generate(
        gemItems.length,
        (index) => GemItemView(
            quantity: gemItems[index].quantity, price: gemItems[index].price));
  }
