...
class ChallengeRoomView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ChallengeRoomViewModel challengeRoomViewModel =
        context.watch<ChallengeRoomViewModel>();
    final size = MediaQuery.of(context).size;
    final height = size.height;
    final width = size.width;
    final orientation = MediaQuery.of(context).orientation;

    final List<Widget> challengeListSliders =
        challengeRoomViewModel.challengeListSliders;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: (Theme.of(context).brightness == Brightness.dark
                      ? const Color(0XFFFBD85D)
                      : const Color(0XFF1A5D1A).withOpacity(
                          challengeRoomViewModel.current == entry.key
                              ? 0.9
                              : 0.4))),
            ),
          );
