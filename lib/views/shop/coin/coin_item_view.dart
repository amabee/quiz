...
class CoinItemView extends StatelessWidget {
  String quantity;
  String price;
  CoinItemView({Key? key, required this.quantity, required this.price})
      : super(key: key);
            ...
            onTap: () {
              showDialog<void>(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    content: Text(
                        'Do you want to buy $quantity coins for $price gems?'),
                    actions: <Widget>[
                      TextButton(
                        child: const Text('No'),
                        onPressed: () {
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          ...
                          userViewModel
                              .getCurrentUser(); // it is gonna update user information visually
                        },
                      ),
                    ],
                  );
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.only(
                        top: orientation == Orientation.portrait ? 17 : 40),
                    child: Column(
                      children: [
                        Image.asset(
                          'lib/assets/icons/coinShop.png',
                  ...
                  Container(
                    color: coinPriceBarColor,
                    width: double.infinity,
                    child: Center(
                        child: Padding(
                      padding: EdgeInsets.all(
                        orientation == Orientation.portrait ? 0 : 5,
                      ),
                      child: Row(
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsets.only(
                              right:
                                  orientation == Orientation.portrait ? 5 : 0,
                            ),
                            child: Text(
                              price,
                              style: TextStyle(
                          ...
                          Image.asset(
                            'lib/assets/icons/diamondShop.png',
                            width: orientation == Orientation.portrait
                                ? width / 30
                                : width / 18,
                            height: orientation == Orientation.portrait
