...
class GemItemView extends StatelessWidget {
  String quantity;
  String price;
  GemItemView({Key? key, required this.quantity, required this.price})
      : super(key: key);
            ...
            onTap: () {
              showDialog<void>(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    content:
                        Text('Do you want to buy $quantity gems for $price?'),
                    actions: <Widget>[
                      TextButton(
                        child: const Text('No'),
                        onPressed: () {
