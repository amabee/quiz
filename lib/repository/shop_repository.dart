...
class ShopRepository {
  ...
  Future<List<Map<String, dynamic>>> loadGem() async {
    ...
    final List<ShopItemModel> gemList = [
      ShopItemModel(quantity: '100', price: '₱50'),
      ShopItemModel(quantity: '500', price: '₱100'),
      ShopItemModel(quantity: '1000', price: '₱150'),
      ShopItemModel(quantity: '2000', price: '₱300'),
      ShopItemModel(quantity: '5000', price: '₱500'),
      ShopItemModel(quantity: '10000', price: '₱800'),
    ];
    if (maps.isNotEmpty) {
      return maps;
    } else {
